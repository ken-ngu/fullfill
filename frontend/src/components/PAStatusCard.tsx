...
export function PAStatusCard({ pa }: Props) {
  if (!pa.required) {
    return (
      <div className="bg-slate-50 border border-slate-200 shadow-card rounded-2xl p-4 flex items-start gap-3">
  ...
  return (
    <div className="bg-amber-50 border border-amber-200 shadow-card rounded-2xl p-4">
